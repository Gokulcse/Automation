...
public class PostHomePagePO extends BaseDriver

{
	...
	@FindBy(how=How.XPATH,using="//div[@class='bl-kit-inn-cnt']//h3[contains(text(),'80')]")
	public static WebElement TextSimh4; //new Element
	
	@FindBy(how=How.XPATH,using="//section[@id='kit-inc']//p[contains(.,'Post')]")
	...
	@FindBy(how=How.XPATH,using="//section[@id='what-iot']//p[1]")
