...
public class UnicomReferralRequestPO 
{
	...
	@FindBy(how=How.XPATH,using="//label[text()='Provinces']")
	public static WebElement ProvincesLabel;
	
	@FindBy(how=How.XPATH,using="//select[@id='stateId']")
	public static WebElement ProvincesInput;
	...
	@FindBy(how=How.XPATH,using="//label[text()='Nano']")
	public static WebElement Sim2FFLabel;
	
	@FindBy(how=How.XPATH,using="//label[text()='Micro']")
	public static WebElement Sim3FFlabel;
	
	@FindBy(how=How.XPATH,using="//label[text()='Standard']")
	...
	@FindBy(how=How.XPATH,using="//div[@id='stateId-error']")
	public static WebElement ProvincesError;
	
	@FindBy(how=How.XPATH,using="//div[@id='device-error']")
