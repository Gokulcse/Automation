...
public class UnicomYourInfoPO 
{
	...
	@FindBy(how=How.XPATH,using="//label[text()='Provinces']") //new element
	public static WebElement ProvincesLabel;
	
	@FindBy(how=How.XPATH,using="//select[@name='stateId']") //new element
	...
	@FindBy(how=How.XPATH,using="//select[@name='industryId']")
