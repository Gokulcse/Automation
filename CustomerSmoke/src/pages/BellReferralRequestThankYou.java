...
public class BellReferralRequestThankYou extends BaseDriver
{
	...
	{
		UtilityMethods.pageRedirection(BellReferralRequestThankYouPO.BellLogo, BellReferralRequestThankYouPO.WhatIsIotImage);		
	...
	{
		UtilityMethods.pageRedirection(BellReferralRequestThankYouPO.BackToIOT,BellReferralRequestThankYouPO.WhatIsIotImage);		
		System.out.println(""+"TS001");
	}
}
