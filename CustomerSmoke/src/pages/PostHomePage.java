...
public class PostHomePage extends BaseDriver
{
	...
	{	
		UtilityMethods.whatTheKitIncludesImageAndTextValidation(PostHomePagePO.CenterIcon, allInputValue.getProperty("PostCenterIcon"), PostHomePagePO.CenterText,"Full Access to Post M2M Control Center");
	...
	{
		UtilityMethods.Imagevalidation(PostHomePagePO.WhatIsIotImage, "src" , "http://Post.devm2m.com/img/Post/whatisiot.png", "What is IoT?");
